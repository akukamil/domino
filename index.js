...
online_player={
	...
	send_move(data){		
		...
		this.write_fb_timer=setTimeout(function(){game.stop('my_no_connection');}, 5000);  
...
lobby={
	...
	activate() {
		...
		if (!this.activated){			
			...
			this.sw_header.header_list=[['ДОБРО ПОЖАЛОВАТЬ В ИГРУ ДОМИНО ОНЛАЙН!','WELCOME!!!'][LANG],room_desc]
